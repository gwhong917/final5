...
##############################################################################
AWS_ACCESS_KEY_ID = 'AKIASYDPHV6BVKQ7TWFV' # .csv 파일에 있는 내용을 입력 Access key ID
AWS_SECRET_ACCESS_KEY = 'Xhit4Ej3Bu4QOABET+jdm9zmjkv/YR6EyKdMujWQ' # .csv 파일에 있는 내용을 입력 Secret access key
